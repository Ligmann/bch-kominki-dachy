...
function process_pug(cb) {
    gulp.src([
            ...
            'src/pug/source-files/offer.pug',
...
function process_image(c_input_path, stats) {
    ...
    compress_images(
        c_input_path,
        "build/images/", { compress_force: false, statistic: false, autoupdate: true },
        false, { jpg: { engine: 'webp', command: false } }, { png: { engine: 'webp', command: false } }, { svg: { engine: 'svgo', command: '--multipass' } }, { gif: { engine: 'gif2webp', command: false } },
        function() {}
    );
}
...
function process_image2(c_input_path, stats) {
    ...
    compress_images(
        c_input_path,
        "build/images/", { compress_force: false, statistic: false, autoupdate: true },
        false, { jpg: { engine: 'mozjpeg', command: false } }, { png: { engine: 'optipng', command: false } }, { svg: { engine: false, command: false } }, { gif: { engine: 'gifsicle', command: ['--colors', '64', '--use-col=web', '--scale', '1.0'] } },
        function() {}
    );
}
